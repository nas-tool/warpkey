...
This project is optimized for Vercel Serverless/Edge functions with Vercel KV (Redis).

1.  **Fork** this repository.
2.  **Deploy** to Vercel.
3.  **Configure Storage**: Create a Vercel KV store and link it to your project.
